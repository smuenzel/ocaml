...
let () = print_endline (o#n o)
[%%expect{|
Uncaught exception: File "typing/ctype.ml", line 3619, characters 13-19: Assertion failed
...
[%%expect{|
Uncaught exception: File "typing/ctype.ml", line 3518, characters 29-35: Assertion failed
