...
let rec reduce_cmm = function
  | Cop
      ...
      Log_perf.log dbg Lps_cmm_simp_nested_cmp;
      Cop
        ( Ccmpi cmp_outer
  ...
  | Cop
      ...
      Log_perf.log dbg Lps_cmm_simp_nested_eq_1;
  ...
  | Cop
      ...
      Log_perf.log dbg Lps_cmm_simp_nested_eq_3;
      Cop (Ccmpi cmp_inner, [left; right], dbg) |> reduce_cmm
  | Cop
      ( Ccmpi Cne
      ...
      (* nested-nequal-zero
         Size: (2 ops, 5 heads) in -> (1 ops, 3 heads) out *)
      Log_perf.log dbg Lps_cmm_simp_nested_neq_0;
      Cop (Ccmpi cmp_inner, [left; right], dbg) |> reduce_cmm
  | Cop
      ( Cand
      , [ Cop
      ...
      Log_perf.log dbg_op Lps_cmm_simp_tag_and;
      Cop
        ( Caddi
        , [ Cop
              ( Clsl
  ...
  | Cop
      ...
      (* tag-or
         Size: (5 ops, 11 heads) in -> (3 ops, 7 heads) out *)
      Log_perf.log dbg_op Lps_cmm_simp_tag_or;
      Cop
        ( Caddi
        , [ Cop
              ( Clsl
  ...
  | Cop
      ...
      Log_perf.log dbg_xor Lps_cmm_simp_tag_xor;
      Cop
        ( Caddi
        , [ Cop
              ( Clsl
